# UI-automation smoke test for ScanWise.
# Loads test_scan.png, clicks Magic Perspective / Apply Perspective, and saves screenshots.
...
public class Win32 {
    ...
    public static Bitmap CaptureWindow(IntPtr hWnd) {
        ...
        PrintWindow(hWnd, hdcDest, 0x00000002); // PW_RENDERFULLCONTENT
...
$shotPath = Join-Path $repoRoot 'screenshot_loaded.png'
Save-WindowShot $proc.MainWindowHandle $shotPath
Write-Host "Saved $shotPath"

Invoke-Button $root 'Magic Perspective'
Start-Sleep -Seconds 1
$shotPath = Join-Path $repoRoot 'screenshot_magic.png'
Save-WindowShot $proc.MainWindowHandle $shotPath
Write-Host "Saved $shotPath"

Invoke-Button $root 'Apply Perspective'
Start-Sleep -Seconds 1
$shotPath = Join-Path $repoRoot 'screenshot_applied.png'
Save-WindowShot $proc.MainWindowHandle $shotPath
Write-Host "Saved $shotPath"
